...
const HoofSideUp = ({ numberPawnSave, setNumberPawnSave, idPaw, setNumberPawnPart, modificarPosicion }) => {
  ...
  return (
    <View style={styles.container}>
      <Svg height={svgDimensions.height} width={svgDimensions.width} viewBox="0 0 1024 800">
        <G>
